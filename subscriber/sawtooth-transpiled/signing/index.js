...
var _require = require('./core'),
    NoSuchAlgorithmError = _require.NoSuchAlgorithmError,
    SigningError = _require.SigningError,
...
function () {
   ...
   */
  function Signer(context, privateKey) {
...
function () {
   ...
   * @param {Context} context - a cryptographic context
   */
  function CryptoFactory(context) {
    _classCallCheck(this, CryptoFactory);
  ...
  _createClass(CryptoFactory, [{
    ...
    key: "newSigner",
    value: function newSigner(privateKey) {
...
var createContext = function createContext(algorithmName) {
  if (algorithmName === 'secp256k1') {
    return new secp256k1.Secp256k1Context();
  } else {
    throw new NoSuchAlgorithmError("No such algorithm: ".concat(algorithmName));
  }
};
